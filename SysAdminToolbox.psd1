@{
    ...
    GUID              = '762901f7-cdcc-4d0e-9a16-50d63b886f5d'

    # Autor dieses Moduls
    Author            = 'Johannes Koenig'

    # Unternehmen oder Hersteller dieses Moduls
    CompanyName       = 'None'

    # Urheberrechtserklärung für dieses Modul
    Copyright         = '(c) 2018 Johannes Koenig. Alle Rechte vorbehalten.'

    # Beschreibung der von diesem Modul bereitgestellten Funktionen
    Description = "A bunch of simple powershell tools to make Sysadmins' everyday work easier"
    ...
    FunctionsToExport = @('Convert-MacToIPv6',
        'ConvertTo-CamelCase',
