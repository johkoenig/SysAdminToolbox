function Test-DistinguishedName {
    ...
    PS C:\> Test-DistinguishedName 'OU=Microsoft Exchange Security Groups,DC=company,DC=example,DC=com'
    True

    .EXAMPLE

    PS C:\> 'OU=Microsoft Exchange Security Groups,DC=company,DC=example,DC=com' | Test-DistinguishedName
    True
